...
(async function () {
	...
	model = await tf.loadModel('http://192.168.86.30:8080/final_model_kaggle_version1/model.json');
	$("#selected-image").attr("src", "http://192.168.86.30:8080/assets/samplepic.jpg");
